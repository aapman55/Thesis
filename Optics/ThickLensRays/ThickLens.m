...
classdef ThickLens < handle   
    ...
    methods
        function obj = ThickLens(height, xlocation, leftRadius, rightRadius, midSectionThickness)
            ...
            obj.midSectionRefractionBorders(1) = RefractionBorder( Vector2d(-midSectionThickness/2, height/2),...
                                                                Vector2d(midSectionThickness/2, height/2),...
                                                                obj.nMedium,...
                                                                obj.nLens);
                                                            
            obj.midSectionRefractionBorders(2) = RefractionBorder( Vector2d(-midSectionThickness/2, -height/2),...
                                                                    Vector2d(midSectionThickness/2, -height/2),...
                                                                    obj.nLens,...
                                                                    obj.nMedium);            
        end
